...
def login_linkedin():
    ...
    with open(
        "/Users/christine/VSCode/linkedin_scraping/linkedin_scraping/cookies.json", "r"
    ) as file:
...
creds = ServiceAccountCredentials.from_json_keyfile_name(
    "/Users/christine/VSCode/linkedin_scraping/linkedin_scraping/scrapingkey_2.json",
    scope,
)
